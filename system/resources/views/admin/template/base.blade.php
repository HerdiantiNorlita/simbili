      ...
      <div class="wrapper">
        <nav class="topnav navbar navbar-light">
          ...
          <form class="form-inline mr-auto searchform text-muted ">
            <h3 class="mt-3">SISTEM MONITORING BIAYA LISTRIK KOS</h3>
          </form>
          ...
          <ul class="nav">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle text-muted pr-0" href="{{url('logout')}}" onclick="return confirm('Yakin untuk keluar?')">
                <span class="avatar avatar-sm mt-2">
                  <img src="{{url('public')}}/logo-pln.png" alt="..." class="avatar-img rounded-circle">
                </span>
              </a>
        ...
        <aside class="sidebar-left border-right bg-white text-white shadow" id="leftSidebar" data-simplebar>
